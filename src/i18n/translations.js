...
export const translations = {
  en: {
    ...
    about: {
      ...
      p1: "I'm a Web Developer with a Bachelor's degree in Informatics, most at home where clean backend logic meets an interface people never have to think about. Through my degree I designed and shipped web-based information systems — the kind that replace a spreadsheet, a notebook, or a filing cabinet with something faster and much harder to lose.",
  ...
  id: {
    ...
    about: {
      ...
      p1: 'Saya seorang Web Developer lulusan S1 Informatika, paling nyaman bekerja di titik temu antara logika backend yang rapi dan antarmuka yang tidak membuat penggunanya berpikir dua kali. Sepanjang kuliah saya merancang dan membangun sistem informasi berbasis web — sistem yang menggantikan spreadsheet, buku catatan, dan lemari arsip dengan sesuatu yang jauh lebih cepat dan jauh lebih sulit hilang.',
